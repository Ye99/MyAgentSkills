...
- **folder-poi-itinerary-rename** ([`folder-poi-itinerary-rename/SKILL.md`](folder-poi-itinerary-rename/SKILL.md)): Rename day-based media folders from a single folder or recursive root scan, then emit JSON stats (including renamed/already-named/no-landmark counts) for verification.
