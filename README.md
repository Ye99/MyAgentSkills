...
- **folder-poi-itinerary-rename** ([`folder-poi-itinerary-rename/SKILL.md`](folder-poi-itinerary-rename/SKILL.md)): Rename date-based media folders by sampling GPS-tagged files, clustering locations, and appending itinerary-ordered landmark-first POI labels.
